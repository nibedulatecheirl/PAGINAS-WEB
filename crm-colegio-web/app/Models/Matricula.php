...
class Matricula extends Model
{
    ...
    public static function generarNumero(): string
    {
        ...
        $numero = static::where('numero', 'like', "MAT{$anio}%")
            ->pluck('numero')
            ->reduce(function (int $max, string $numeroMatricula) use ($anio): int {
                return preg_match("/^MAT{$anio}(\d+)$/", $numeroMatricula, $matches)
