...
class Configuracion extends Model
{
    ...
    public static function notaMaxima(): float       { return (float) static::get('nota_maxima', 20); }
    public static function numBimestres(): int       { return (int) static::get('num_bimestres', 4); }
