...
class MensajeController extends Controller
{
    public function index()
    {
        ...
        return view('messages.index', compact('recibidos', 'enviados', 'noLeidos', 'usuarios'));
    }
    ...
    {
        if (!in_array(auth()->id(), [$mensaje->remitente_id, $mensaje->destinatario_id], true)) {
            abort(403, 'No puedes leer este mensaje.');
        }
    ...
    {
        if ($mensaje->destinatario_id !== auth()->id()) {
            abort(403, 'Solo puedes archivar mensajes recibidos.');
        }
