...
<div style="display:flex;gap:12px;align-items:center;margin-bottom:20px;">
    ...
    @endif
    @if(auth()->user()->canAccess('pagos'))
        <a href="{{ route('pagos.index') }}?alumno_id={{ $alumno->id }}" class="btn btn-success"><i class="fas fa-money-bill"></i> Registrar Pago</a>
    @endif
</div>
...
<div class="grid grid-3" style="gap:20px;">
    ...
    <div style="display:flex;flex-direction:column;gap:20px;">
        ...
        <div class="card" style="text-align:center;padding:28px 20px;">
            <div style="width:80px;height:80px;border-radius:20px;background:linear-gradient(135deg,#18324d,#4f86bd);display:flex;align-items:center;justify-content:center;color:white;font-size:32px;font-weight:800;margin:0 auto 16px;">
            ...
            <div style="margin-top:16px;padding:12px;background:#f0f7ff;border-radius:10px;">
                ...
                <div style="font-weight:700;color:#18324d;">{{ $mat->grado->nombre ?? '—' }}</div>
        ...
        {{-- Datos personales --}}
        <div class="card">
            <div class="card-header"><span class="card-title"><i class="fas fa-id-card" style="color:#4f86bd;margin-right:8px;"></i>Datos Personales</span></div>
            <div class="card-body" style="padding:0;">
                ...
                <div style="display:flex;align-items:center;gap:12px;padding:12px 20px;border-bottom:1px solid var(--border);">
                    <div style="width:32px;height:32px;border-radius:8px;background:#eef3f8;display:flex;align-items:center;justify-content:center;color:#66758a;font-size:13px;flex-shrink:0;">
                        <i class="{{ $icon }}"></i>
                    </div>
                    <div>
        ...
        {{-- Apoderado --}}
        <div class="card">
            <div class="card-header"><span class="card-title"><i class="fas fa-user-friends" style="color:#168a68;margin-right:8px;"></i>Apoderado</span></div>
            <div class="card-body" style="padding:0;">
                @foreach([
    ...
    <div style="grid-column:span 2;display:flex;flex-direction:column;gap:20px;">
        ...
        <div class="card">
            <div class="card-header">
                <span class="card-title"><i class="fas fa-file-signature" style="color:#4f86bd;margin-right:8px;"></i>Historial de Matrículas</span>
        ...
        <div class="card">
            <div class="card-header">
                <span class="card-title"><i class="fas fa-receipt" style="color:#168a68;margin-right:8px;"></i>Estado de Cuenta</span>
