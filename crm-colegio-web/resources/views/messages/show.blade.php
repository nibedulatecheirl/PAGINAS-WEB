...
<div class="card">
    ...
    <div style="padding:24px 28px;border-bottom:1px solid var(--border);">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
            <div style="display:flex;align-items:center;gap:12px;">
                <div style="width:44px;height:44px;border-radius:12px;background:linear-gradient(135deg,#18324d,#4f86bd);display:flex;align-items:center;justify-content:center;color:white;font-weight:700;font-size:16px;">
    ...
    {{-- Footer --}}
    <div style="padding:16px 28px;border-top:1px solid var(--border);background:#f7fafd;border-radius:0 0 16px 16px;">
