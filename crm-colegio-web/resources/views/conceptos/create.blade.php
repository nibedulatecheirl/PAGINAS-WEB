...
<div class="card">
    <div class="card-header">
        <span class="card-title"><i class="fas fa-tag" style="color:#4f86bd;margin-right:8px;"></i>Datos del Concepto</span>
    </div>
    <div class="card-body">
        ...
        <div class="form-group">
            <label style="display:flex;align-items:center;gap:10px;cursor:pointer;">
                <input type="checkbox" name="activo" value="1" {{ old('activo',1) ? 'checked':'' }}
                    style="width:18px;height:18px;accent-color:#4f86bd;">
