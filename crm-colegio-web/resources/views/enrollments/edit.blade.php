...
<div class="card">
    <div class="card-header">
        <span class="card-title"><i class="fas fa-edit" style="color:#4f86bd;margin-right:8px;"></i>Editar Matrícula — {{ $matricula->numero }}</span>
    </div>
    <div class="card-body">
        {{-- Alumno (solo lectura) --}}
        <div class="form-group">
            <label class="form-label">Alumno</label>
            <div style="padding:10px 14px;background:#f7fafd;border:1.5px solid var(--border);border-radius:10px;font-weight:600;color:var(--text);">
