...
<div class="card" style="margin-bottom:20px;">
    <div class="card-header">
        <span class="card-title"><i class="fas fa-id-badge" style="color:#4f86bd;margin-right:8px;"></i>Datos Personales</span>
    </div>
    <div class="card-body">
...
<div class="card" style="margin-bottom:20px;">
    <div class="card-header">
        <span class="card-title"><i class="fas fa-briefcase" style="color:#168a68;margin-right:8px;"></i>Datos Laborales</span>
    </div>
    <div class="card-body">
        <div class="grid grid-3">
            <div class="form-group">
