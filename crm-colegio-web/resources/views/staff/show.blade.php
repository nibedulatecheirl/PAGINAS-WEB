...
<div style="display:flex;gap:12px;margin-bottom:20px;">
    ...
    <a href="{{ route('personal.index') }}?editar_personal={{ $personal->id }}" class="btn btn-primary"><i class="fas fa-edit"></i> Editar</a>
</div>
...
<div class="grid grid-3" style="gap:20px;">
    ...
    <div class="card" style="text-align:center;padding:32px 24px;">
        <div style="width:80px;height:80px;border-radius:20px;background:linear-gradient(135deg,#065f46,#168a68);display:flex;align-items:center;justify-content:center;color:white;font-size:30px;font-weight:800;margin:0 auto 16px;">
