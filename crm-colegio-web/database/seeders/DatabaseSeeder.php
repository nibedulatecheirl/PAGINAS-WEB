...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── CONCEPTOS DE PAGO ──
        ConceptoPago::create(['nombre' => 'Matrícula 2026', 'descripcion' => 'Inscripción anual del estudiante', 'monto' => 450.00, 'tipo' => 'matricula', 'activo' => true]);
        $mensualidad = ConceptoPago::create(['nombre' => 'Mensualidad Primaria', 'descripcion' => 'Pensión mensual para aulas de primaria', 'monto' => 300.00, 'tipo' => 'mensualidad', 'activo' => true]);
        ConceptoPago::create(['nombre' => 'Materiales Educativos', 'descripcion' => 'Cuaderno de trabajo, fichas y recursos de aula', 'monto' => 120.00, 'tipo' => 'otros', 'activo' => true]);
        ConceptoPago::create(['nombre' => 'Taller de Computación', 'descripcion' => 'Taller extracurricular mensual', 'monto' => 80.00, 'tipo' => 'taller', 'activo' => true]);
        ConceptoPago::create(['nombre' => 'APAFA', 'descripcion' => 'Aporte anual de asociación de padres', 'monto' => 60.00, 'tipo' => 'otros', 'activo' => true]);
        ...
        $docenteUser = User::create([
            'name'        => $docentes[0]->nombre_completo,
            'email'       => 'docente@colegio.edu.pe',
            'password'    => Hash::make('admin123'),
            'role'        => 'docente',
            'personal_id' => $docentes[0]->id,
            'activo'      => true,
        ]);
        $docentes[0]->update(['user_id' => $docenteUser->id]);
        ...
        if ($primerAlumno) {
            User::create([
                'name'      => $primerAlumno->nombre_completo,
                'email'     => 'estudiante@colegio.edu.pe',
                'password'  => Hash::make('admin123'),
                'role'      => 'estudiante',
