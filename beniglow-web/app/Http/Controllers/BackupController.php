...
class BackupController extends Controller
{
    ...
    {
        try {
            $directorio = $this->ensureBackupDirectory();
    ...
    {
        $ruta = $this->backupPath($backup->archivo);
        if (!file_exists($ruta)) {
    ...
    {
        $directorio = $this->backupDirectory();
    ...
    private function backupPath(string $archivo): string
    {
        return $this->backupDirectory() . DIRECTORY_SEPARATOR . basename($archivo);
    }
