...
cls
echo ============================================================
echo   BENIGLOW STORE - INSTALACION RAPIDA (solo base de datos)
...
echo.
echo Importando estructura y datos iniciales en base 'beniglow_store'...
...
echo ============================================================
echo.
echo La base 'beniglow_store' esta creada con la estructura limpia.
echo.
echo Credenciales:
echo   admin / admin123
echo.
