...
cls
echo ============================================================
echo   BENIGLOW STORE - INSTALADOR AUTOMATICO
...
echo  4) Crear base de datos beniglow_store
...
echo.
echo [4/6] Creando base de datos beniglow_store en MySQL...
echo Ingresando con usuario root sin contrasena ^(estandar Laragon^)...
"%MYSQL_BIN%" -u root -e "CREATE DATABASE IF NOT EXISTS beniglow_store DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;" 2>nul
if errorlevel 1 (
    echo.
    ...
    if "!MYSQL_PASS!"=="" (
        "%MYSQL_BIN%" -u root -e "CREATE DATABASE IF NOT EXISTS beniglow_store DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
    ) else (
        "%MYSQL_BIN%" -u root -p!MYSQL_PASS! -e "CREATE DATABASE IF NOT EXISTS beniglow_store DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
    )
    if errorlevel 1 (
...
if errorlevel 1 (
    ...
    "%MYSQL_BIN%" -u root beniglow_store < database\install.sql
    if errorlevel 1 (
...
if defined LARAGON_PATH (
    ...
    echo                       y abre http://beniglow-store.test
